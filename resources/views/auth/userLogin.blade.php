...
<div class="login-box">
    ...
    <div class="column">
        ...
        >>>>>>> 01451d5448cd7717a1ed32ed4b937b2b6d5aa403
    </div>
</div>
</div>
        ...
        <div class="login-box-form" style="width: 400px; text-align: center; margin: auto">
            ...
            <form method="post" action="{{route('postUsLogin')}}" class="mt-2" onsubmit="return validateForm()"
                ...
                <div class="form-group">
                    ...
                    <a href="{{route('register')}}">
                        <small class="text-theme"
                            style="font-style: italic; float: left; margin-top: 10px; margin-left: 10px"><strong>Đăng ký
                                tài khoản</strong></small>
                    </a>
                    <a href="{{route('forgotPass')}}">
                        <small class="text-theme"
                            style="font-style: italic; float: right; margin-top: 10px; margin-right: 10px"><strong>Quên
                                mật khẩu?</strong></small>
                    </a>
                </div>
            </form>
        </div>
